...
#define LISP_REPO    "https://github.com/howerj/lisp"
...
again:
	...
	case LISP_CONS: { /* This could be turned into `apply` */
		...
		l->depth = depth;
                if (lisp_type_get(proc) == LISP_PRIMITIVE)
...
static void *lisp_allocator(void *arena, void *ptr, const size_t oldsz, const size_t newsz) {
	...
	if (newsz > oldsz) { 
		if (!ptr) { /* TODO: realloc of node pointer will fail... */
